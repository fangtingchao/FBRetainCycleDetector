...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.1'
  s.summary          = 'A short description of FBRetainCycleDetector.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'FBRetainCycleDetector/Classes/**/*'
  
  # s.resource_bundles = {
  #   'FBRetainCycleDetector' => ['FBRetainCycleDetector/Assets/*.png']
  # }
